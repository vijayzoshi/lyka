...
class AllExpertsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      //  chipPsychologist.isChecked = true
/*
        if(chipPsychologist.isChecked == true){
            chipPsychologist.chipStrokeColor = ColorStateList.valueOf(Color.parseColor("#FF0000"))  // Red stroke

        }else if(chipPsychiatrist.isChecked== true){
            chipPsychiatrist.chipStrokeColor = ColorStateList.valueOf(Color.parseColor("#FF0000"))  // Red stroke
        }
 ...
 */
        ...
        chipPsychologist.setOnClickListener {
          ...
          //  chipPsychologist.isChecked = true
            //chipPsychiatrist.isChecked = false
            chipPsychologist.chipStrokeColor = ColorStateList.valueOf(Color.parseColor("#FF0000"))  // Red stroke
        ...
        chipPsychiatrist.setOnClickListener {
           ...
           // chipPsychologist.isChecked = false
          //  chipPsychiatrist.isChecked = true
            chipPsychiatrist.chipStrokeColor = ColorStateList.valueOf(Color.parseColor("#FF0000"))  // Red stroke


        }

        chipPsychologist.setOnCheckedChangeListener { chip, isChecked ->
            // Responds to chip checked/unchecked
        }

        /*
        // Listen for chip selection events
        chipGroup.setOnCheckedStateChangeListener { group, checkedIds ->
            // Find the selected chip using the checkedId
            val selectedChip = findViewById<Chip>(checkedIds)
            val chipText = selectedChip.text
            // Perform an action with the selected chip's text
    ...
    private fun showBottomsheet() {
        val dailogview = layoutInflater.inflate(R.layout.bottomsheet_filter, null)
        val dailog = BottomSheetDialog(this)
